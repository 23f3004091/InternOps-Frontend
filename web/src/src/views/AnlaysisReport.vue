...
<template>
    <div class="min-h-screen bg-[#0f172a] text-slate-300 font-sans p-4 sm:p-8 overflow-y-auto flex justify-center">
        
        <div class="w-full max-w-4xl bg-[#1e293b] shadow-2xl rounded-xl border border-slate-700/50 overflow-hidden relative">
